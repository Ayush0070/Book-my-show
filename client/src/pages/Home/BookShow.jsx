              ...
              extra={
                <div className="show-name py-3">
                  ...
                  <h3>
                    ...
                    {(show?.totalSeats || 0) - (show?.bookedSeats?.length || 0)}
                  </h3>
                </div>
              }
              style={{ width: "100%" }}
...
const PaymentForm = ({ show, selectedSeats, user, onBooking }) => {
  ...
  const handlePayment = async () => {
    try {
      ...
      if (!response.success) throw new Error("Payment init failed");
      ...
      if (result.paymentIntent.status === "succeeded") {
        ...
        onBooking(result.paymentIntent.id);
      }
